...
class GWindow:
	...
	def setWindowTitle(self, title):
		...
		platform.Platform().setWindowTitle(self, title)
	...
	def draw(self, gobj, x=None, y=None):
		...
		platform.Platform().draw(self, gobj)
	...
	def addToRegion(self, gobj, region):
		...
		@rtype: void
		'''
		platform.Platform().addToRegion(self, gobj, region)
	...
	def removeFromRegion(self, gobj, region):
		...
		@rtype: void		
 		'''
		platform.Platform().removeFromRegion(self, gobj, region)
	...
	def setRegionAlignment(self, region, align):
		...
		@type align: string
		'''
		platform.Platform().setRegionAlignment(self, region, align)
...
def pause(milliseconds):
	...
	@rtype: void
	'''
	platform.Platform().pause(milliseconds)
...
def getScreenWidth():
	...
	@rtype: float
	'''
	return platform.Platform().getScreenWidth()
...
def getScreenHeight():
	...
	@rtype: float
	'''
	return platform.Platform().getScreenHeight();	
...
def exitGraphics():
	...
	@rtype: void
	'''
	platform.Platform().exitGraphics()
