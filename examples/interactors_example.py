...
from spgl import ginteractors
from spgl import gevents

window = gwindow.GWindow(width=1000,height=600)
addInteract = ginteractors.GButton("Add")
removeInteract = ginteractors.GButton("Remove")
filledInteract = ginteractors.GCheckBox("Filled: ")
captionInteract = ginteractors.GTextField(20)
redInteract = ginteractors.GSlider(0,255,0)
greenInteract = ginteractors.GSlider(0,255,0)
blueInteract = ginteractors.GSlider(0,255,0)
sizeInteract = ginteractors.GChooser()
...
obj = gobjects.GOval(150,150, objX, objY)
window.add(obj)
cap = gobjects.GLabel("")
...
while(True):
	...
	if(e.getEventType() == gevents.EventType.ACTION_PERFORMED):
